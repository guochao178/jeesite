	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("input[name=id]").each(function(){
				...
				if (top.jerichotabiframe_1.cmsMainFrame){
					//articleSelect = top.mainFrame.cmsMainFrame.articleSelect;
					articleSelect = top.jerichotabiframe_1.cmsMainFrame.articleSelect;
				}else{
					//articleSelect = top.mainFrame.articleSelect;
					articleSelect = top.jerichotabiframe_1.articleSelect;
				}
				...
				$(this).click(function(){
					...
					if (top.jerichotabiframe_1.cmsMainFrame){
						...
						top.jerichotabiframe_1.cmsMainFrame.articleSelectAddOrDel(id, title);
					}else{
						//top.mainFrame.articleSelectAddOrDel(id, title);
						top.jerichotabiframe_1.articleSelectAddOrDel(id, title);
					}
				});
			});
		});
